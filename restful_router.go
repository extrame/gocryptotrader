...
// 	fmt.Fprint(w, "<html>GoCryptoTrader RESTful interface. For the web GUI, please visit the <a href=https://github.com/extrame/gocryptotrader/blob/master/web/README.md>web GUI readme.</a></html>")
