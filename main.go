...
import (
	...
	"github.com/extrame/gocryptotrader/currency/forexprovider"

	"github.com/extrame/gocryptotrader/common"
	"github.com/extrame/gocryptotrader/communications"
...
func main() {
	...
	if bot.config.Grpc.Enabled {
		...
		grpcServer, _ = StartGrpcServer(bot.config.Grpc.ListenAddress)
	} else {
